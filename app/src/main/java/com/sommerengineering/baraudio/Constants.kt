...
const val nqTopicTitle = "Nasdaq-100 (NQ)"
const val esTopicTitle = "S&P-500 (ES)"
const val btcTopicTitle = "BTC/USD (BTC)" // todo "spot" not futures
...
const val nqTopicDescription = "Momentum expansion, percent move, cascade/exhaustion"
const val esTopicDescription = "Volume expansion, participation, range expansion"
const val btcTopicDescription = "Stop cascade, blowoff exhaustion, percent move"
