...
const val btcTopicTitle = "Bitcoin (BTC)" // todo "spot" not futures
...
const val nqTopicDescription = "Momentum & velocity"
const val esTopicDescription = "Market participation"
const val btcTopicDescription = "Volatility & extremes"
